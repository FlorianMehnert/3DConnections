...
namespace _3DConnections.Editor.NodeGraph
{
    ...
    public class ComponentElement : VisualElement
    {
        ...
        private Dictionary<string, Port> m_ReferenceOutputPorts = new Dictionary<string, Port>();
        private Dictionary<string, PropertyField> m_PropertyFields = new Dictionary<string, PropertyField>();
        
        public Component Component => m_Component;
        public Dictionary<string, Port> ReferenceOutputPorts => m_ReferenceOutputPorts;
        
        public ComponentElement(Component component, GameObjectGraphNode parentNode)
        {
        ...
        private void CreatePropertyElement(SerializedProperty property)
        {
            ...
            {
                var outputPort = m_ParentNode.InstantiatePort(Orientation.Horizontal, Direction.Output, Port.Capacity.Single, typeof(Object));
