namespace _3DConnections.Runtime.Nodes.Layout
{
    ...
    public class ConnectionsBasedForestManager
    {
        ...
        private static void CalculateLevelCounts(TreeNode node, int level, Dictionary<int, int> levelCounts,
        ...
        private static void FindCycleRoots(TreeNode node, HashSet<TreeNode> visited, HashSet<TreeNode> inStack,
            List<TreeNode> cycleRoots)
        {
