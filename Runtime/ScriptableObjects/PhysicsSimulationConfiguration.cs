namespace _3DConnections.Runtime.ScriptableObjects
{
    ...
    [CreateAssetMenu(fileName = "PhysicsSimConfig",
        menuName = "3DConnections/ScriptableObjects/Physics Simulation Configuration", order = 1)]
    public class PhysicsSimulationConfiguration : ScriptableObject
    {
        ...
        [SerializeField] private SimulationType simulationType = SimulationType.Static;
